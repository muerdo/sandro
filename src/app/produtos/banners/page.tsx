...
const product = {
  ...
  price: 149.90,
  description: "Banners em lona com acabamento profissional. Ideal para eventos, promoções e publicidade.",
  images: [
    "/img/plot.png",
  ...
  features: [
    "Lona de alta resistência",
    "Impressão em alta resolução",
    "Resistente à intempéries",
    "Acabamento com ilhós",
    "Durabilidade de até 2 anos",
    "Personalização completa"
  ],
  customization: {
    types: ["Fosco", "Brilhante"],
    sizes: ["1x1m", "2x2m", "3x3m", "Personalizado"]
  }
};
