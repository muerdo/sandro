    ...
    <main className="min-h-screen bg-background py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                ...
                <div>
                  ...
                  <div className="mt-2 flex gap-2 text-sm">
                    <span className="text-orange-500">
                      {stats.low_stock_products} Baixo Estoque
                    </span>
                    <span className="text-destructive">
                      {stats.out_of_stock_products} Acabou!
                    </span>
                  </div>
                </div>
              </div>
          ...
          >
            <h2 className="text-xl font-semibold mb-6">Alerta de Inventário</h2>
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          ...
          <motion.div
            ...
            className="bg-card p-6 rounded-xl shadow-lg"
          >
            <h2 className="text-xl font-semibold mb-6">Performance do Produto</h2>
            <div className="w-full h-[400px]">
              <BarChart
                width={500}
                height={400}
          ...
          <motion.div
            ...
            className="bg-card p-6 rounded-xl shadow-lg"
          >
            <h2 className="text-xl font-semibold mb-6">Aquisições</h2>
            <div className="w-full h-[400px]">
              <AreaChart
                width={500}
                height={400}
          ...
          <motion.div
            ...
            className="bg-card p-6 rounded-xl shadow-lg col-span-2"
          >
            <h2 className="text-xl font-semibold mb-6">Distribuição por Categoria</h2>
            <div className="w-full h-[400px]">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-3 px-4">Pedido ID</th>
